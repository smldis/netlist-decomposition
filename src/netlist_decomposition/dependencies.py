...
def render_dependency_table(
    ...
    lines = [
        ...
        "",
        "```{note}",
        "**This page is generated. Do not edit it by hand.**  It is rendered from",
        "`netlist_decomposition.dependencies` by",
        "`scripts/generate_decomposition_dependencies.py`; a hand edit is silently",
        "reverted by the next regeneration and fails",
        "`python scripts/generate_decomposition_dependencies.py --check`.  To change",
        "what it says, change the catalog in the source module.",
        "```",
        "",
